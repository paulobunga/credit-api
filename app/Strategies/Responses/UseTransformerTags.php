...
class UseTransformerTags extends Strategy
{
    ...
    public function getTransformerResponse(array $tags): ?array
    {
        ...
        [$statusCode, $transformer, $append] = $this->getStatusCodeAndTransformerClass($transformerTag);
        ...
        if ((strtolower($transformerTag->getName()) == 'transformercollection')) {
            ...
            $resource = (new Item($modelInstance, empty($append) ? new $transformer() : new $transformer($append), $resourceKey));
        }
